...
import CourseAccordionBar from "../componet/dashbord/Course/CourseAccordionBar"
...
function CourseDetails() {
  ...
  useEffect(() => {
    ...
    ; (async () => {
      try {
         await axios.post(`${import.meta.env.VITE_BASE_URL}/course/api/getCourseDetails`,
          { courseId },
          ...
          .then((res) => {
            ...
            RiContactsBookUploadLine.log(error)
          })
      } catch (error) {
