...
import Upload from "../UploadThumnail"
...
export default function SubSectionModal({
    ...
    const handleEditSubsection = async () => {
        ...
        setLoading(true)
        await axios.put(`${import.meta.env.VITE_BASE_URL}/section/api/updateSubSection`,
            formData,
            { withCredentials: true }
        ).then((res) => {

            const updatedCourseContent = course.courseContent.map((section) =>
                section._id === modalData.sectionId ? res.data.data : section
            )
