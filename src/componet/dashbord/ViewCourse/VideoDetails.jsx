...
const VideoDetails = () => {
    ...
    const setVideoSpecificDetails = async() => {
        ...
        if(!courseId && !sectionId && !subSectionId) {
            ...
            const filteredData = courseSectionData.filter(
                ...
                console.log("qqqqqqq",filteredData);
  ...
  const handleLectureCompletion = async() => {
    ...
    //PENDING - > Course Progress PENDING
     await axios.post(`${import.meta.env.VITE_BASE_URL}/course/api/updateCourseProgress`,
    ...
    {withCredentials:true}
        ...
        console.log("error accure in markDone")
        toast.error("failed to markdone")
    })   
    setLoading(false);
